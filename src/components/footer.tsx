/** Pages below live on Munda Manager: this app has no copies of its own. */
const MUNDA_MANAGER_URL = "https://www.mundamanager.com";

const LINK_CLASSES = "text-sm text-fg-muted transition-colors hover:text-fg";
...
export const SOCIALS = [
  ...
  },
  {
    ...
    href: "https://github.com/joeseos/mundamanager-roleplay",
    viewBox: "0 0 496 512",
...
/** Munda Manager's site footer, with this app's name and repository. */
export function Footer() {
  return (
    <footer className="border-t border-line bg-chrome shadow-md print:hidden">
      <div className="mx-auto max-w-5xl py-6 pr-[10px] pl-6 md:px-[10px]">
        <div className="flex flex-col gap-8 md:flex-row md:gap-12">
          <div className="flex flex-1 flex-col gap-2">
            <div className="mb-2 flex items-center gap-2">
              ...
              />
              <span className="text-lg font-bold">Munda Manager Roleplay</span>
            </div>
          ...
          <FooterLinks
            ...
            links={RESOURCES}
          />
          <FooterLinks heading="Info" label="Information" links={INFO} />
          <div className="flex flex-col gap-2">
            <h3 className="mb-1 text-sm font-semibold">Follow Us</h3>
        ...
        <div className="mt-8 border-t border-line pt-6">
          <div className="flex flex-wrap items-center justify-center gap-2 text-xs text-fg-muted">
            ...
            <span>/</span>
            <a
              href={`${MUNDA_MANAGER_URL}/privacy-policy`}
              className="transition-colors hover:text-fg"
            >
              Privacy Policy
            </a>
